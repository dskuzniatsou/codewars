...
//     // Equity matching: If candidate desires equity, the job must offer some (equityMax > 0)
//     if (candidate.desiresEquity && job.equityMax === 0) {
//       return false;
//     }
    
//     // Location matching: Job location must be in candidate's current or desired locations
