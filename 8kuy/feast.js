...
function feast(beast, dish) {
    //your function here
    const iLastBeast = beast.length - 1;
    const iLastDish = dish.length - 1;
    return (beast.charAt(0) === dish.charAt(0)) && (beast.charAt(iLastBeast) === dish.charAt(iLastDish)) ? true : false
}
